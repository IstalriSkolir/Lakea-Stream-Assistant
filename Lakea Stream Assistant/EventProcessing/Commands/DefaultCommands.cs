    ...
    public class DefaultCommands
    {
        ...
        public DefaultCommands(ConfigSettings settings, ExternalProcesses externalProcesses, KeepAliveToken keepAliveToken)
        {
            ...
            this.commandFunctions = new Dictionary<string, CommandBase>
            {
                ...
                { "totalpoints", new TotalPointsCommand(settings.ResourcePath) },
                { "topbits", topBits },
                { "topcheers", topBits },
                { "streak", streak },
                { "watchstreak", streak }             
            ...
            this.commandConfigs = new Dictionary<string, CommandConfiguration>
            {
                ...
                { "totalpoints", new CommandConfiguration("Total Points", settings.Commands.TotalPoints.Enabled, settings.Commands.TotalPoints.ModOnly) },
